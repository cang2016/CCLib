...
namespace DataBase
{
    ...
    public abstract class DatabaseHelper
    {
        ...
        public  int ExecteNonQuery(string connectionString, CommandType cmdType, string cmdText, params SqlParameter[] commandParameters)
        {
        ...
        public  DataTableCollection GetTable(string connecttionString, CommandType cmdTye, string cmdText, SqlParameter[] commandParameters)
        {
            SqlCommand cmd = new SqlCommand();
        ...
        /// <param name="commandParameters">以数组形式提供SqlCommand命令中用到的参数列表</param>
        /// <returns>返回一个表集合(DataTableCollection)表示查询得到的数据集</returns>
        public  DataTableCollection GetTable(CommandType cmdTye, string cmdText, SqlParameter[] commandParameters)
        {
        ...
        /// <param name="commandParameters">以数组形式提供SqlCommand命令中用到的参数列表</param>
        /// <returns>返回一个表集合(DataTableCollection)表示查询得到的数据集</returns>
        public  DataTableCollection GetTableProducts(string cmdText, SqlParameter[] commandParameters)
        {
        ...
        public  DataView ExecuteDataSet(string connectionString, string sortExpression, string direction, CommandType cmdType, string cmdText, params SqlParameter[] commandParameters)
        {
            SqlConnection conn = new SqlConnection(connectionString);
            SqlCommand cmd = new SqlCommand();
            try
        ...
        {
            return ExecuteScalar(DatabaseHelper.connectionString, cmdType, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteScalar(DatabaseHelper.connectionString, CommandType.StoredProcedure, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteScalar(DatabaseHelper.connectionString, CommandType.Text, cmdText, commandParameters);
        }
        ...
        {
            int cmdresult = Convert.ToInt32(ExecuteScalar(connectionString, CommandType.Text, cmdText, null));
            if (cmdresult == 0)
            {
                return false;
            }
        ...
        /// <returns>bool结果</returns>
        public bool Exists(string cmdText, params SqlParameter[] cmdParms)
        {
            int cmdresult = Convert.ToInt32(ExecuteScalar(connectionString, CommandType.Text, cmdText, cmdParms));
            if (cmdresult == 0)
            {
                return false;
            }
