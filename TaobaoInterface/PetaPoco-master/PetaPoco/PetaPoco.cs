...
namespace DataBase
{
    ...
    public interface IDatabase : IDatabaseQuery
    {
        ...
        void FillDataTable(DataTable dt, string sql, params object[] args);
        void FillDataSet(DataSet dt, string sql, params object[] args);
    }

    // Database class ... this is where most of the action happens
    public class Database :DatabaseHelper, IDisposable, IDatabase
    {
        ...
        public DataTable FillDataTable(string sql)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    {
                        DataAdapter da = new SqlDataAdapter(cmd as SqlCommand);
        ...
        public void FillDataSet(DataSet ds, string sql, params object[] args)  
        {  
            OpenSharedConnection();  
        ...
        /// <param name="sql">Sql语句</param>  
        /// <param name="args">参数</param>  
        public void FillDataTable(DataTable dt, string sql, params object[] args)  
        {  
            OpenSharedConnection();  
